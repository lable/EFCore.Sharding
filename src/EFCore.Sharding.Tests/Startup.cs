    ...
    public class Startup
    {
        ...
        public static void Begin(TestContext context)
        {
            ...
            services.AddEFCoreSharding(config =>
            {
                ...
                // config.AddDataSource("server=localhost;uid=postgres;password=;database=test;port=5433;commandtimeout=1024;",
                //     ReadWriteType.Read | ReadWriteType.Write,
                ...
                config.SetDateSharding<SqlDefaultTestModel>(nameof(SqlDefaultTestModel.ModifiedOn), ExpandByDateMode.PerMonth, startTime);
            });
